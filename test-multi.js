...
const LANDING_INSTRUCTIONS = `You are a world-class web designer. Your job is to create a beautiful, complete, single-page website.
...
async function runGenerateMode(opts) {
  ...
  async function runJob(job) {
    ...
    if (fromReference) {
      ...
      prompt += `\n\nDESIGN STYLE:\nYou have complete creative freedom. Choose the visual style, color palette, typography, and layout that best fits the content described above. Make bold, opinionated design choices — do NOT default to generic startup templates. Show us YOUR design instinct.`;
    }
