      ...
      <div class="hero-bottom">
        ...
        <p class="hero-opensource">
          <a href="https://github.com/viola-engineering/designfast" target="_blank" rel="noopener">
            ...
            Open source
          </a> — self-host with your own API keys or use the <a href="https://github.com/viola-engineering/designfast#cli-via-claude-code" target="_blank" rel="noopener">CLI with Claude Code</a>
        </p>
      </div>
    </section>
