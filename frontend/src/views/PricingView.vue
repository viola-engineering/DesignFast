...
const featureTableRows = computed(() => [
  ...
  { feature: 'Gemini cost (single page)', free: '1 generation', pro: '1 credit' },
  { feature: 'Gemini cost (webapp)', free: '1 generation', pro: '4 credits' },
  { feature: 'Claude cost (single page)', free: '-', pro: '10 credits' },
  { feature: 'Claude cost (webapp)', free: '-', pro: '40 credits' },
...
const faqs = [
  {
    ...
    answer: 'Buy credits once, use them anytime. Each generation costs credits based on the model and mode: single-page costs 1 credit (Gemini) or 10 credits (Claude), multi-page webapp costs 4x (4 credits for Gemini, 40 for Claude). Multiple styles multiply the cost. Credits never expire. When your credits run out, you can still use Gemini with up to 3 fallback generations per month.'
  },
  {
